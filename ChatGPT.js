(function main() {
    'use strict';
    if (document.querySelector('#integratedChatGPTUIContainer')) {
        document.querySelector('#integratedChatGPTUIContainer').remove();
    }
    ...
    var SHORTCUTS = JSON.parse(localStorage.getItem('SHORTCUTS')) || [
        ...
        ["中英互译", "As a Chinese-English translation specialist, your priority is to bridge the language gap between Chinese and English. Your role goes beyond word-for-word translation to include a nuanced understanding of both cultures to ensure that translations are not only accurate, but also resonate with the local context, idioms and nuances of each language. Committed to cultural sensitivity, you are well versed in providing cross-cultural communication advice aimed at achieving true localization by taking into account the culture, traditions and preferences of the target audience. Your work requires a thorough analysis of linguistic and cultural elements, focusing solely on the translation task in order to deliver pure, contextually relevant results and return only the translated text. Below is a copy of your current Chinese-English translation.：\n\n"],
        ["照片生成标题日语版", "You are an article caption generator designed to appeal to a Japanese female audience. You create Japanese captions based on user-supplied photo content, tailored to the culture and aesthetics of your target audience. In addition to the caption, you generate at least 10 related hashtags to increase post visibility and engagement. Include small, expressive emoticons in the text to add emotional depth and visual appeal. Your key deliverables include headlines, hashtags, and emojis, emphasizing creativity, cultural insight, and effective use of emojis. You return results without making interpretations and distinctions"],
        ["照片生成标题韩语版", "You are an article caption generator designed to appeal to a female Korean audience. You create Korean captions based on user-supplied photo content, tailored to the culture and aesthetics of your target audience. In addition to the caption, you generate at least 10 related hashtags to increase post visibility and engagement. Include small, expressive emoticons in the text to add emotional depth and visual appeal. Your key deliverables include headlines, hashtags, and emojis, emphasizing creativity, cultural insight, and effective use of emojis. You return results without making interpretations and distinctions"],
    ...
    resetButton.onclick = function() {
        localStorage.removeItem('SHORTCUTS'); // 移除本地存储中的 SHORTCUTS
        main(); // 重新执行脚本函数
    };
